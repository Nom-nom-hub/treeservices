    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); closeMobileMenu(); }} className="flex items-center gap-3 group"><Logo className="h-12 w-auto group-hover:opacity-80 transition-opacity grayscale" /></a>
            </div>
      ...
      <footer className="bg-black text-gray-400 py-12 px-4 border-t-2 border-black">
        <div className="max-w-7xl mx-auto"><div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="reveal"><Logo className="h-12 w-auto mb-4 invert" /><p className="text-sm text-gray-500 leading-relaxed font-light">Professional tree care serving Southwest Florida since 1991. Licensed &amp; Insured.</p></div>
